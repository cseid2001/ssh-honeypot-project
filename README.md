...
- A **Wazuh Elastic Stack VM** running the Wazuh All-in-One Docker deployment, which includes Wazuh Manager, Elasticsearch, Logstash, and Filebeat.
...
Going forward, I plan to expand on this lab by incorporating other types of honeypots (Dionaea really caught my eye), refining alerting rules, settung up Grafana alerts, and experimenting with threat intelligence integration to build a more complete view of attacker tactics, techniques, and procedures (TTPs). 
